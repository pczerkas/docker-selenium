# Selenium Grid Standalone - Edge Debug
...
[`selenium/standalone-edge-debug` Dockerfile](Dockerfile)

## How to use this image


```
$ docker run -d -p 4444:4444 -p 5900:5900 -v /dev/shm:/dev/shm selenium/standalone-edge-debug
```
...
``` dockerfile
FROM selenium/selenium-node-edge-debug-debug:3.141.59-20210929
